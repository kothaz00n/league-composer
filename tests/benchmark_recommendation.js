require('./mock_axios');
const { getRecommendations, getCompositionAnalysis } = require('../src/engine/recommend');
const { initializeEngine } = require('../src/engine/recommend');
const championsData = require('../src/data/champions');
...
console.time('getRecommendations x 1000');
...
console.timeEnd('getRecommendations x 1000');
