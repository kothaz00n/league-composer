...
function getCompositionAnalysis(teamRoles, queue = 'soloq') {
    ...
    // Performance optimization: Pre-calculate the current team member names into a Set
    // This avoids O(N) array allocation and search (Object.values(teamRoles).includes)
    // inside the nested candidate evaluation loop, reducing time complexity.
